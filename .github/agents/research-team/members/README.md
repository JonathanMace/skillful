# Research Team — Member Roster

This file is maintained by the coordinator (research-team agent). It lists all
available team members, their categories, domains, and dispatch history.
...
*(Members moved here when no longer actively needed. Leave instruction files in place — they can be re-activated.)*
