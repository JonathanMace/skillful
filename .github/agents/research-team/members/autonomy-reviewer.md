...
- Whether "the coordinator decides" is actually specified as a concrete decision procedure, or is hand-waving
...
### Decision Procedures
For each "the coordinator decides" moment: is the decision procedure specified concretely enough that an agent could actually make the decision?
...
5. Trace decision trees — when the coordinator "assesses" or "decides," is there actually enough information and procedure to make that decision?
